<x-app-layout>
    ...
    <div class="max-w-4xl mx-auto animate-fade-in-up">
        ...
        <div class="mb-8 text-center">
            <h2 class="font-outfit text-3xl font-bold text-slate-900">Analisis Nutrisi & Kondisi Lahan</h2>
            <p class="mt-2 text-slate-500 text-sm sm:text-base">Masukkan parameter tanah dan lingkungan Anda untuk mendapatkan rekomendasi tanaman serta klasifikasi tipe lahan berbasis AI.</p>
        </div>
            ...
            <div class="rounded-3xl border border-slate-200 bg-white p-6 sm:p-8 shadow-sm">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-400 uppercase tracking-wider font-semibold">Langkah 01 — Unsur Hara Makro</p>
                    </div>
                </div>
            ...
            <div class="rounded-3xl border border-slate-200 bg-white p-6 sm:p-8 shadow-sm">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-400 uppercase tracking-wider font-semibold">Langkah 02 — Data Klimatologi</p>
                    </div>
                </div>
