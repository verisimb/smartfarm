<x-app-layout>
    ...
    <div class="space-y-8 animate-fade-in-up">
        <!-- Welcome Section -->
        <div class="relative overflow-hidden rounded-3xl bg-emerald-600 p-8 text-white shadow-lg shadow-emerald-200">
        ...
        <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            <!-- Total Prediksi -->
            <div class="group rounded-3xl border border-slate-200 bg-white p-6 transition-all duration-300 hover:border-emerald-200 hover:shadow-md">
            ...
            <div class="group rounded-3xl border border-slate-200 bg-white p-6 transition-all duration-300 hover:border-emerald-200 hover:shadow-md sm:col-span-2 lg:col-span-1">
                <div class="flex items-center justify-between">
                    <div class="flex h-12 w-12 items-center justify-center rounded-2xl bg-slate-50 text-slate-600 transition-colors group-hover:bg-emerald-50 group-hover:text-emerald-600">
        ...
        <div class="grid gap-8 lg:grid-cols-12">
            ...
            <div class="rounded-3xl border border-slate-200 bg-white lg:col-span-8 overflow-hidden shadow-sm shadow-slate-100">
                            ...
                            @forelse($latestPredictions as $prediction)
                                <tr class="group hover:bg-slate-50/50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <a href="{{ route('predictions.show', $prediction->id) }}" class="inline-flex h-8 w-8 items-center justify-center rounded-full text-slate-400 hover:bg-white hover:text-emerald-600 hover:shadow-sm border border-transparent hover:border-slate-100 transition-all">
            ...
            <div class="space-y-6 lg:col-span-4">
                <div class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm shadow-slate-100">
                ...
                <div class="rounded-3xl border border-emerald-100 bg-emerald-50/50 p-6 border-dashed">
                    ...
                    <a href="{{ route('predictions.create') }}" class="mt-4 flex w-full items-center justify-center gap-2 rounded-2xl bg-emerald-600 py-3 text-sm font-bold text-white transition-all hover:bg-emerald-700 hover:shadow-md active:scale-[0.98]">
